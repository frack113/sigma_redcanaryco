...
[Enumerate credentials from Windows Credential Manager using vaultcmd.exe [Web Credentials]](tests/bc071188-459f-44d5-901a-f8f2625b2d2e.md) ['windows'] :x: 
...
[Packet Capture macOS](tests/9d04efee-eff5-4240-b8d2-07792b873608.md) ['macos'] :x: 
...
[Dump individual process memory with Python (Local)](tests/437b2003-a20d-4ed8-834c-4964f24eec63.md) ['linux'] :x: 
...
[Automated Collection Command Prompt](tests/cb379146-53f1-43e0-b884-7ce2c635ff5b.md) ['windows'] :x: 
...
[Windows Screencapture](tests/3c898f62-626c-47d5-aad2-6de873d69153.md) ['windows'] :x: 
...
[Clear history of a bunch of shells](tests/7e6721df-5f08-4370-9255-f06d8a77af4c.md) ['linux', 'macos'] :x: 
...
[Stop/Start UFW firewall](tests/fe135572-edcd-49a2-afe6-1d39521c5a9a.md) ['linux'] :x: 
...
[Stop and Remove Arbitrary Security Windows Service](tests/ae753dda-0f15-4af6-a168-b9ba16143143.md) ['windows'] :x: 
...
[Mac Hidden file](tests/cddb9098-3b47-4e01-9d3b-6f5f323288a9.md) ['macos'] :x: 
...
[InstallHelper method call](tests/d43a5bde-ae28-4c55-a850-3f4c80573503.md) ['windows'] :x: 
...
[Creating W32Time similar named service using schtasks](tests/f9f2fe59-96f7-4a7d-ba9f-a9783200d4c9.md) ['windows'] :x: 
...
[Msiexec.exe - Execute Arbitrary DLL](tests/66f64bd5-7c35-4c24-953a-04ca30a0a0ec.md) ['windows'] :x: 
...
[DCShadow (Active Directory)](tests/0f4c5eb0-98a0-4496-9c3d-656b4f2bc8f6.md) ['windows'] :x: 
...
[Renamed Microsoft.Workflow.Compiler.exe Payload Executions](tests/4cc40fd7-87b8-4b16-b2d7-57534b86b911.md) ['windows'] :x: 
...
[Windows - Modify file last access timestamp with PowerShell](tests/da627f63-b9bd-4431-b6f8-c5b44d061a62.md) ['windows'] :x: 
...
[Create a new account similar to ANONYMOUS LOGON](tests/dc7726d2-8ccb-4cc6-af22-0d5afb53a548.md) ['windows'] :x: 
...
[Install Outlook Home Page Persistence](tests/7a91ad51-e6d2-4d43-9471-f26362f5738e.md) ['windows'] :x: 
...
[Install MS Exchange Transport Agent Persistence](tests/43e92449-ff60-46e9-83a3-1a38089df94d.md) ['windows'] :x: 
...
[Web Shell Written to Disk](tests/0a2ce662-1efa-496f-a472-2fe7b080db16.md) ['windows'] :x: 
...
[Change User Password - Windows](tests/1b99ef28-f83c-4ec5-8a08-1a56263a5bb2.md) ['windows'] :x: 

[Delete User - Windows](tests/f21a1d7d-a62f-442a-8c3a-2440d43b19e5.md) ['windows'] :x: 

[Remove Account From Domain Admin Group](tests/43f71395-6c37-498e-ab17-897d814a0947.md) ['windows'] :x: 

[Windows - Overwrite file with Sysinternals SDelete](tests/476419b5-aebf-4366-a131-ae3e8dae5fc2.md) ['windows'] :x: 

[macOS/Linux - Overwrite file with DD](tests/38deee99-fd65-4031-bec8-bfa4f9f26146.md) ['linux', 'macos'] :x: 

[Encrypt files using gpg (Linux)](tests/7b8ce084-3922-4618-8d22-95f996173765.md) ['linux'] :x: 

[Encrypt files using 7z (Linux)](tests/53e6735a-4727-44cc-b35b-237682a151ad.md) ['linux'] :x: 

[Encrypt files using ccrypt (Linux)](tests/08cbf59f-85da-4369-a5f4-049cffd7709f.md) ['linux'] :x: 

[Encrypt files using openssl (Linux)](tests/142752dc-ca71-443b-9359-cf6f497315f1.md) ['linux'] :x: 

[PureLocker Ransom Note](tests/649349c7-9abf-493b-a7a2-b1aa4d141528.md) ['windows'] :x: 

[Windows - Delete Volume Shadow Copies](tests/43819286-91a9-4369-90ed-d31fb4da2c01.md) ['windows'] :x: 

[Windows - Delete Volume Shadow Copies via WMI](tests/6a3ff8dd-f49c-4272-a658-11c2fe58bd88.md) ['windows'] :x: 

[Windows - wbadmin Delete Windows Backup Catalog](tests/263ba6cb-ea2b-41c9-9d4e-b652dadd002c.md) ['windows'] :x: 

[Windows - Disable Windows Recovery Console Repair](tests/cf21060a-80b3-4238-a595-22525de4ab81.md) ['windows'] :x: 

[Windows - Delete Volume Shadow Copies via WMI with PowerShell](tests/39a295ca-7059-4a88-86f6-09556c1211e7.md) ['windows'] :x: 

[Windows - Delete Backup Files](tests/6b1dbaf6-cc8a-4ea6-891f-6058569653bf.md) ['windows'] :x: 

[Windows - wbadmin Delete systemstatebackup](tests/584331dd-75bc-4c02-9e0b-17f5fd81c748.md) ['windows'] :x: 

[Windows - Disable the SR scheduled task](tests/1c68c68d-83a4-4981-974e-8993055fa034.md) ['windows'] :x: 

[Replace Desktop Wallpaper](tests/30558d53-9d76-41c4-9267-a7bd5184bed3.md) ['windows'] :x: 

[macOS/Linux - Simulate CPU Load with Yes](tests/904a5a0e-fb02-490d-9f8d-0e256eb37549.md) ['macos', 'linux'] :x: 

[Windows - Stop service using Service Controller](tests/21dfb440-830d-4c86-a3e5-2a491d5a8d04.md) ['windows'] :x: 

[Windows - Stop service using net.exe](tests/41274289-ec9c-4213-bea4-e43c4aa57954.md) ['windows'] :x: 

[Windows - Stop service by killing process](tests/f3191b84-c38b-400b-867e-3a217a27795f.md) ['windows'] :x: 

[Shutdown System - Windows](tests/ad254fa8-45c0-403b-8c77-e00b3d3e7a64.md) ['windows'] :x: 

[Restart System - Windows](tests/f4648f0d-bf78-483c-bafc-3ec99cd1c302.md) ['windows'] :x: 

[Restart System via `shutdown` - macOS/Linux](tests/6326dbc4-444b-4c04-88f4-27e94d0327cb.md) ['macos', 'linux'] :x: 

[Shutdown System via `shutdown` - macOS/Linux](tests/4963a81e-a3ad-4f02-adda-812343b351de.md) ['macos', 'linux'] :x: 

[Restart System via `reboot` - macOS/Linux](tests/47d0b042-a918-40ab-8cf9-150ffe919027.md) ['macos', 'linux'] :x: 

[Shutdown System via `halt` - Linux](tests/918f70ab-e1ef-49ff-bc57-b27021df84dd.md) ['linux'] :x: 

[Reboot System via `halt` - Linux](tests/78f92e14-f1e9-4446-b3e9-f1b921f2459e.md) ['linux'] :x: 

[Shutdown System via `poweroff` - Linux](tests/73a90cd2-48a2-4ac5-8594-2af35fa909fa.md) ['linux'] :x: 

[Reboot System via `poweroff` - Linux](tests/61303105-ff60-427b-999e-efb90b314e41.md) ['linux'] :x: 

[List Process Main Windows - C# .NET](tests/fe94a1c3-3e22-4dc9-9fdf-3a8bdbc10dc4.md) ['windows'] :heavy_check_mark: 

[List Mozilla Firefox Bookmark Database Files on Linux](tests/3a41f169-a5ab-407f-9269-abafdb5da6c2.md) ['linux'] :x: 

[List Mozilla Firefox Bookmark Database Files on macOS](tests/1ca1f9c7-44bc-46bb-8c85-c50e2e94267b.md) ['macos'] :x: 
...
[Permission Groups Discovery PowerShell (Domain)](tests/6d5d8c96-3d2a-4da9-9d6d-9a9d341899a7.md) ['windows'] :x: 

[Elevated group enumeration using net group (Domain)](tests/0afb5163-8181-432e-9405-4322710c0c37.md) ['windows'] :x: 

[Find machines where user has local admin access (PowerView)](tests/a2d71eee-a353-4232-9f86-54f4288dd8c1.md) ['windows'] :x: 

[Find local admins on all machines in domain (PowerView)](tests/a5f0d9f8-d3c9-46c0-8378-846ddd6b1cbd.md) ['windows'] :x: 

[Find Local Admins via Group Policy (PowerView)](tests/64fdb43b-5259-467a-b000-1b02c00e510a.md) ['windows'] :x: 

[Enumerate Users Not Requiring Pre Auth (ASRepRoast)](tests/870ba71e-6858-4f6d-895c-bb6237f6121b.md) ['windows'] :x: 

[Adfind - Query Active Directory Groups](tests/48ddc687-82af-40b7-8472-ff1e742e8274.md) ['windows'] :x: 

[Windows - Discover domain trusts with dsquery](tests/4700a710-c821-4e17-a3ec-9e4c81d6845f.md) ['windows'] :x: 

[Windows - Discover domain trusts with nltest](tests/2e22641d-0498-48d2-b9ff-c71e496ccdbe.md) ['windows'] :x: 

[Powershell enumerate domains and forests](tests/c58fbc62-8a62-489e-8f2d-3565d7d96f30.md) ['windows'] :x: 

[Adfind - Enumerate Active Directory OUs](tests/d1c73b96-ab87-4031-bad8-0e1b3b8bf3ec.md) ['windows'] :x: 

[Adfind - Enumerate Active Directory Trusts](tests/15fe436d-e771-4ff3-b655-2dca9ba52834.md) ['windows'] :x: 

[Get-DomainTrust with PowerView](tests/f974894c-5991-4b19-aaf5-7cc2fe298c5d.md) ['windows'] :x: 

[Get-ForestTrust with PowerView](tests/58ed10e8-0738-4651-8408-3a3e9a526279.md) ['windows'] :x: 

[File and Directory Discovery (cmd.exe)](tests/0e36303b-6762-4500-b003-127743b80ba6.md) ['windows'] :x: 

[File and Directory Discovery (PowerShell)](tests/2158908e-b7ef-4c21-8a83-3ce4dd05a924.md) ['windows'] :x: 

[Nix File and Diectory Discovery](tests/ffc8b249-372a-4b74-adcd-e4c0430842de.md) ['macos', 'linux'] :x: 

[Nix File and Directory Discovery 2](tests/13c5e1ae-605b-46c4-a79f-db28c77ff24e.md) ['macos', 'linux'] :x: 

[Enumerate all accounts (Local)](tests/f8aab3dd-5990-4bf8-b8ab-2226c951696f.md) ['linux'] :x: 

[View sudoers access](tests/fed9be70-0186-4bde-9f8a-20945f9370c2.md) ['linux', 'macos'] :x: 

[View accounts with UID 0](tests/c955a599-3653-4fe5-b631-f11c00eb0397.md) ['linux', 'macos'] :x: 

[List opened files by user](tests/7e46c7a5-0142-45be-a858-1a3ecb4fd3cb.md) ['linux', 'macos'] :x: 

[Show if a user account has ever logged in remotely](tests/0f0b6a29-08c3-44ad-a30b-47fd996b2110.md) ['linux'] :x: 

[Enumerate users and groups](tests/e6f36545-dc1e-47f0-9f48-7f730f54a02e.md) ['linux', 'macos'] :x: 

[Enumerate users and groups](tests/319e9f6c-7a9e-432e-8c62-9385c803b6f2.md) ['macos'] :x: 

[Enumerate all accounts on Windows (Local)](tests/80887bec-5a9b-4efc-a81d-f83eb2eb32ab.md) ['windows'] :x: 

[Enumerate all accounts via PowerShell (Local)](tests/ae4b6361-b5f8-46cb-a3f9-9cf108ccfe7b.md) ['windows'] :x: 

[Enumerate logged on users via CMD (Local)](tests/a138085e-bfe5-46ba-a242-74a6fb884af3.md) ['windows'] :x: 

[Permission Groups Discovery (Local)](tests/952931a4-af0b-4335-bbbe-73c8c5b327ae.md) ['macos', 'linux'] :x: 

[Basic Permission Groups Discovery Windows (Local)](tests/1f454dd6-e134-44df-bebb-67de70fb6cd8.md) ['windows'] :x: 

[Permission Groups Discovery PowerShell (Local)](tests/a580462d-2c19-4bc7-8b9a-57a41b7d3ba4.md) ['windows'] :heavy_check_mark: 

[SharpHound3 - LocalAdmin](tests/e03ada14-0980-4107-aff1-7783b2b59bb1.md) ['windows'] :x: 

[Wmic Group Discovery](tests/7413be50-be8e-430f-ad4d-07bf197884b2.md) ['windows'] :heavy_check_mark: 

[WMIObject Group Discovery](tests/69119e58-96db-4110-ad27-954e48f3bb13.md) ['windows'] :heavy_check_mark: 

[Port Scan](tests/68e907da-2539-48f6-9fc9-257a78c05540.md) ['linux', 'macos'] :x: 

[Port Scan Nmap](tests/515942b0-a09f-4163-a7bb-22fefb6f185f.md) ['linux', 'macos'] :x: 

[Port Scan NMap for Windows](tests/d696a3cb-d7a8-4976-8eb5-5af4abf2e3df.md) ['windows'] :x: 

[Port Scan using python](tests/6ca45b04-9f15-4424-b9d3-84a217285a5c.md) ['windows'] :x: 

[Network Share Discovery](tests/f94b5ad9-911c-4eff-9718-fd21899db4f7.md) ['macos'] :x: 

[Network Share Discovery - linux](tests/875805bc-9e86-4e87-be86-3a5527315cae.md) ['linux'] :x: 

[Network Share Discovery command prompt](tests/20f1097d-81c1-405c-8380-32174d493bbb.md) ['windows'] :x: 

[Network Share Discovery PowerShell](tests/1b0814d1-bb24-402d-9615-1b20c50733fb.md) ['windows'] :x: 

[View available share drives](tests/ab39a04f-0c93-4540-9ff2-83f862c385ae.md) ['windows'] :x: 

[Share Discovery with PowerView](tests/b1636f0a-ba82-435c-b699-0d78794d8bfd.md) ['windows'] :x: 

[PowerView ShareFinder](tests/d07e4cc1-98ae-447e-9d31-36cb430d28c4.md) ['windows'] :x: 
...
[Examine password complexity policy - Ubuntu](tests/085fe567-ac84-47c7-ac4c-2688ce28265b.md) ['linux'] :x: 

[Examine password complexity policy - CentOS/RHEL 7.x](tests/78a12e65-efff-4617-bc01-88f17d71315d.md) ['linux'] :x: 

[Examine password complexity policy - CentOS/RHEL 6.x](tests/6ce12552-0adb-4f56-89ff-95ce268f6358.md) ['linux'] :x: 

[Examine password expiration policy - All Linux](tests/7c86c55c-70fa-4a05-83c9-3aa19b145d1a.md) ['linux'] :x: 

[Examine local password policy - Windows](tests/4588d243-f24e-4549-b2e3-e627acc089f6.md) ['windows'] :x: 

[Examine domain password policy - Windows](tests/46c2c362-2679-4ef5-aec9-0e958e135be4.md) ['windows'] :x: 

[Examine password policy - macOS](tests/4b7fa042-9482-45e1-b348-4b756b2a0742.md) ['macos'] :x: 

[Win32_PnPEntity Hardware Inventory](tests/2cb4dbf2-2dca-4597-8678-4d39d207a3a5.md) ['windows'] :x: 

[Process Discovery - ps](tests/4ff64f0b-aaf2-4866-b39d-38d9791407cc.md) ['macos', 'linux'] :x: 

[Process Discovery - tasklist](tests/c5806a4f-62b8-4900-980b-c7ec004e9908.md) ['windows'] :x: 

[Query Registry](tests/8f7578c4-9863-4d83-875c-a565573bbdf0.md) ['windows'] :heavy_check_mark: 

[Remote System Discovery - net](tests/85321a9c-897f-4a60-9f20-29788e50bccd.md) ['windows'] :x: 

[Remote System Discovery - net group Domain Computers](tests/f1bf6c8f-9016-4edf-aff9-80b65f5d711f.md) ['windows'] :x: 

[Remote System Discovery - nltest](tests/52ab5108-3f6f-42fb-8ba3-73bc054f22c8.md) ['windows'] :x: 

[Remote System Discovery - ping sweep](tests/6db1f57f-d1d5-4223-8a66-55c9c65a9592.md) ['windows'] :x: 

[Remote System Discovery - arp](tests/2d5a61f5-0447-4be4-944a-1f8530ed6574.md) ['windows'] :x: 

[Remote System Discovery - arp nix](tests/acb6b1ff-e2ad-4d64-806c-6c35fe73b951.md) ['linux', 'macos'] :x: 

[Remote System Discovery - sweep](tests/96db2632-8417-4dbb-b8bb-a8b92ba391de.md) ['linux', 'macos'] :x: 

[Remote System Discovery - nslookup](tests/baa01aaa-5e13-45ec-8a0d-e46c93c9760f.md) ['windows'] :x: 

[Remote System Discovery - adidnsdump](tests/95e19466-469e-4316-86d2-1dc401b5a959.md) ['windows'] :x: 

[Adfind - Enumerate Active Directory Computer Objects](tests/a889f5be-2d54-4050-bd05-884578748bb4.md) ['windows'] :x: 

[Adfind - Enumerate Active Directory Domain Controller Objects](tests/5838c31e-a0e2-4b9f-b60a-d79d2cb7995e.md) ['windows'] :x: 

[Security Software Discovery](tests/f92a380f-ced9-491f-b338-95a991418ce2.md) ['windows'] :x: 

[Security Software Discovery - powershell](tests/7f566051-f033-49fb-89de-b6bacab730f0.md) ['windows'] :x: 

[Security Software Discovery - ps (macOS)](tests/ba62ce11-e820-485f-9c17-6f3c857cd840.md) ['macos'] :x: 

[Security Software Discovery - ps (Linux)](tests/23b91cd2-c99c-4002-9e41-317c63e024a2.md) ['linux'] :x: 

[Security Software Discovery - Sysmon Service](tests/fe613cf3-8009-4446-9a0f-bc78a15b66c9.md) ['windows'] :x: 

[Security Software Discovery - AV Discovery via WMI](tests/1553252f-14ea-4d3b-8a08-d7a4211aa945.md) ['windows'] :x: 

[Find and Display Internet Explorer Browser Version](tests/68981660-6670-47ee-a5fa-7e74806420a4.md) ['windows'] :x: 

[Applications Installed](tests/c49978f6-bd6e-4221-ad2c-9e3e30cc1e3b.md) ['windows'] :x: 

[Find and Display Safari Browser Version](tests/103d6533-fd2a-4d08-976a-4a598565280f.md) ['macos'] :x: 
...
[System Information Discovery](tests/66703791-c902-4560-8770-42b8a91f7667.md) ['windows'] :x: 

[System Information Discovery](tests/edff98ec-0f73-4f63-9890-6b117092aff6.md) ['macos'] :x: 

[List OS Information](tests/cccb070c-df86-4216-a5bc-9fb60c74e27c.md) ['linux', 'macos'] :x: 

[Linux VM Check via Hardware](tests/31dad7ad-2286-4c02-ae92-274418c85fec.md) ['linux'] :x: 

[Linux VM Check via Kernel Modules](tests/8057d484-0fae-49a4-8302-4812c4f1e64e.md) ['linux'] :x: 

[Hostname Discovery (Windows)](tests/85cfbf23-4a1e-4342-8792-007e004b975f.md) ['windows'] :x: 

[Hostname Discovery](tests/486e88ea-4f56-470f-9b57-3f4d73f39133.md) ['linux', 'macos'] :x: 

[Windows MachineGUID Discovery](tests/224b4daf-db44-404e-b6b2-f4d1f0126ef8.md) ['windows'] :x: 

[Griffon Recon](tests/69bd4abe-8759-49a6-8d21-0f15822d6370.md) ['windows'] :x: 

[Environment variables discovery on windows](tests/f400d1c0-1804-4ff8-b069-ef5ddd2adbf3.md) ['windows'] :x: 

[Environment variables discovery on macos and linux](tests/fcbdd43f-f4ad-42d5-98f3-0218097e2720.md) ['macos', 'linux'] :x: 

[System Network Configuration Discovery on Windows](tests/970ab6a1-0157-4f3f-9a73-ec4166754b23.md) ['windows'] :x: 

[List Windows Firewall Rules](tests/038263cb-00f4-4b0a-98ae-0696c67e1752.md) ['windows'] :x: 

[System Network Configuration Discovery](tests/c141bbdb-7fca-4254-9fd6-f47e79447e17.md) ['macos', 'linux'] :x: 

[System Network Configuration Discovery (TrickBot Style)](tests/dafaf052-5508-402d-bf77-51e0700c02e2.md) ['windows'] :x: 

[List Open Egress Ports](tests/4b467538-f102-491d-ace7-ed487b853bf5.md) ['windows'] :x: 

[Adfind - Enumerate Active Directory Subnet Objects](tests/9bb45dd7-c466-4f93-83a1-be30e56033ee.md) ['windows'] :x: 

[Qakbot Recon](tests/121de5c6-5818-4868-b8a7-8fd07c455c1b.md) ['windows'] :x: 

[List macOS Firewall Rules](tests/ff1d8c25-2aa4-4f18-a425-fede4a41ee88.md) ['macos'] :x: 

[System Network Connections Discovery](tests/0940a971-809a-48f1-9c4d-b1d785e96ee5.md) ['windows'] :x: 

[System Network Connections Discovery with PowerShell](tests/f069f0f1-baad-4831-aa2b-eddac4baac4a.md) ['windows'] :x: 

[System Network Connections Discovery Linux & MacOS](tests/9ae28d3f-190f-4fa0-b023-c7bd3e0eabf2.md) ['linux', 'macos'] :x: 

[System Discovery using SharpView](tests/96f974bb-a0da-4d87-a744-ff33e73367e9.md) ['windows'] :x: 

[System Owner/User Discovery](tests/4c4959bf-addf-4b4a-be86-8d09cc1857aa.md) ['windows'] :x: 

[System Owner/User Discovery](tests/2a9b677d-a230-44f4-ad86-782df1ef108c.md) ['linux', 'macos'] :x: 

[Find computers where user has session - Stealth mode (PowerView)](tests/29857f27-a36f-4f7e-8084-4557cd6207ca.md) ['windows'] :x: 

[System Service Discovery](tests/89676ba1-b1f8-47ee-b940-2e1a113ebc71.md) ['windows'] :heavy_check_mark: 

[System Service Discovery - net.exe](tests/5f864a3f-8ce9-45c0-812c-bdf7d8aeacc3.md) ['windows'] :heavy_check_mark: 

[System Time Discovery](tests/20aba24b-e61f-4b26-b4ce-4784f763ca20.md) ['windows'] :x: 

[System Time Discovery - PowerShell](tests/1d5711d6-655c-4a47-ae9c-6503c74fa877.md) ['windows'] :x: 

[System Time Discovery in macOS](tests/f449c933-0891-407f-821e-7916a21a1a6f.md) ['macos'] :x: 

[AppleScript](tests/3600d97d-81b9-4171-ab96-e4386506e2c2.md) ['macos'] :x: 

[At - Schedule a job](tests/7266d898-ac82-4ec0-97c7-436075d0d08e.md) ['linux'] :x: 

[At.exe Scheduled task](tests/4a6c0dc4-0f2a-4203-9298-a5a9bdc21ed8.md) ['windows'] :x: 

[ExecIntoContainer](tests/d03bfcd3-ed87-49c8-8880-44bb772dea4b.md) ['containers'] :x: 
...
[Execute Commands](tests/f592ba2a-e9e8-4d62-a459-ef63abd819fd.md) ['windows'] :x: 

[Execute PowerShell script via Word DDE](tests/47c21fb6-085e-4b0d-b4d2-26d72c3830b3.md) ['windows'] :x: 

[DDEAUTO](tests/cf91174c-4e74-414e-bec0-8d60a104d181.md) ['windows'] :x: 

[Launchctl](tests/6fb61988-724e-4755-a595-07743749d4e2.md) ['macos'] :x: 

[Event Monitor Daemon Persistence](tests/11979f23-9b9d-482a-9935-6fc9cd022c3e.md) ['macos'] :x: 

[OSTap Style Macro Execution](tests/8bebc690-18c7-4549-bc98-210f7019efff.md) ['windows'] :x: 

[OSTap Payload Download](tests/3f3af983-118a-4fa1-85d3-ba4daa739d80.md) ['windows'] :x: 

[Maldoc choice flags command execution](tests/0330a5d2-a45a-4272-a9ee-e364411c4b18.md) ['windows'] :x: 

[OSTAP JS version](tests/add560ef-20d6-4011-a937-2c340f930911.md) ['windows'] :x: 

[Office launching .bat file from AppData](tests/9215ea92-1ded-41b7-9cd6-79f9a78397aa.md) ['windows'] :x: 

[Excel 4 Macro](tests/4ea1fc97-8a46-4b4e-ba48-af43d2a98052.md) ['windows'] :x: 

[Headless Chrome code execution via VBA](tests/a19ee671-ed98-4e9d-b19c-d1954a51585a.md) ['windows'] :x: 

[Potentially Unwanted Applications (PUA)](tests/02f35d62-9fdc-4a97-b899-a5d9a876d295.md) ['windows'] :x: 

[Office Generic Payload Download](tests/5202ee05-c420-4148-bf5e-fd7f7d24850c.md) ['windows'] :x: 

[Execution through API - CreateProcess](tests/99be2089-c52d-4a4a-b5c3-261ee42c8b62.md) ['windows'] :x: 

[Mimikatz](tests/f3132740-55bc-48c4-bcc0-758a459cd027.md) ['windows'] :x: 

[Run BloodHound from local disk](tests/a21bb23e-e677-4ee7-af90-6931b57b6350.md) ['windows'] :x: 

[Run Bloodhound from Memory using Download Cradle](tests/bf8c1441-4674-4dab-8e4e-39d93d08f9b7.md) ['windows'] :x: 

[Obfuscation Tests](tests/4297c41a-8168-4138-972d-01f3ee92c804.md) ['windows'] :x: 

[Mimikatz - Cradlecraft PsSendKeys](tests/af1800cf-9f9d-4fd1-a709-14b1e6de020d.md) ['windows'] :x: 

[Invoke-AppPathBypass](tests/06a220b6-7e29-4bd8-9d07-5b4d86742372.md) ['windows'] :x: 

[Powershell MsXml COM object - with prompt](tests/388a7340-dbc1-4c9d-8e59-b75ad8c6d5da.md) ['windows'] :x: 

[Powershell XML requests](tests/4396927f-e503-427b-b023-31049b9b09a6.md) ['windows'] :x: 

[Powershell invoke mshta.exe download](tests/8a2ad40b-12c7-4b25-8521-2737b0a415af.md) ['windows'] :x: 

[Powershell Invoke-DownloadCradle](tests/cc50fa2a-a4be-42af-a88f-e347ba0bf4d7.md) ['windows'] :x: 

[PowerShell Fileless Script Execution](tests/fa050f5e-bc75-4230-af73-b6fd7852cd73.md) ['windows'] :x: 

[PowerShell Downgrade Attack](tests/9148e7c4-9356-420e-a416-e896e9c0f73e.md) ['windows'] :x: 

[NTFS Alternate Data Stream Access](tests/8e5c5532-1181-4c1d-bb79-b3a9f5dbd680.md) ['windows'] :x: 

[PowerShell Session Creation and Use](tests/7c1acec2-78fa-4305-a3e0-db2a54cddecd.md) ['windows'] :x: 

[ATHPowerShellCommandLineParameter -Command parameter variations](tests/686a9785-f99b-41d4-90df-66ed515f81d7.md) ['windows'] :x: 

[ATHPowerShellCommandLineParameter -Command parameter variations with encoded arguments](tests/1c0a870f-dc74-49cf-9afc-eccc45e58790.md) ['windows'] :x: 

[ATHPowerShellCommandLineParameter -EncodedCommand parameter variations](tests/86a43bad-12e3-4e85-b97c-4d5cf25b95c3.md) ['windows'] :x: 

[ATHPowerShellCommandLineParameter -EncodedCommand parameter variations with encoded arguments](tests/0d181431-ddf3-4826-8055-2dbf63ae848b.md) ['windows'] :x: 

[PowerShell Command Execution](tests/a538de64-1c74-46ed-aa60-b995ed302598.md) ['windows'] :x: 

[PowerShell Invoke Known Malicious Cmdlets](tests/49eb9404-5e0f-4031-a179-b40f7be385e3.md) ['windows'] :x: 

[PowerUp Invoke-AllChecks](tests/1289f78d-22d2-4590-ac76-166737e1811b.md) ['windows'] :x: 

[Execute shell script via python's command mode arguement](tests/3a95cdb2-c6ea-4761-b24e-02b71889b8bb.md) ['linux'] :x: 

[Execute Python via scripts (Linux)](tests/6c4d1dcb-33c7-4c36-a8df-c6cfd0408be8.md) ['linux'] :x: 

[Execute Python via Python executables (Linux)](tests/0b44d79b-570a-4b27-a31f-3bf2156e5eaa.md) ['linux'] :x: 
...
[Execute a Command as a Service](tests/2382dee2-a75f-49aa-9378-f52df6ed3fb1.md) ['windows'] :x: 

[Use PsExec to execute a command on a remote host](tests/873106b7-cfed-454b-8680-fa9f6400431c.md) ['windows'] :x: 

[Radmin Viewer Utility](tests/b4988cad-6ed2-434d-ace5-ea2670782129.md) ['windows'] :x: 
...
[Create and Execute Bash Shell Script](tests/7e7ac3ed-f795-4fa5-b711-09d6fbe9b873.md) ['macos', 'linux'] :x: 

[Command-Line Interface](tests/d0c88567-803d-4dca-99b4-7ce65e7b257c.md) ['macos', 'linux'] :x: 

[Visual Basic script execution to gather local computer information](tests/1620de42-160a-4fe5-bbaf-d3fef0181ce9.md) ['windows'] :x: 

[Encoded VBS code execution](tests/e8209d5f-e42d-45e6-9c2f-633ac4f1eefa.md) ['windows'] :x: 

[Extract Memory via VBA](tests/8faff437-a114-4547-9a60-749652a03df6.md) ['windows'] :x: 

[Create and Execute Batch Script](tests/9e8894c0-50bd-4525-a96c-d4ac78ece388.md) ['windows'] :x: 

[Writes text to a file and displays it.](tests/127b4afe-2346-4192-815c-69042bec570e.md) ['windows'] :x: 

[Suspicious Execution via Windows Command Shell](tests/d0eb3597-a1b3-4d65-b33b-2cda8d397f20.md) ['windows'] :x: 

[WMI Reconnaissance Users](tests/c107778c-dcf5-47c5-af2e-1d058a3df3ea.md) ['windows'] :x: 

[WMI Reconnaissance Processes](tests/5750aa16-0e59-4410-8b9a-8a47ca2788e2.md) ['windows'] :x: 

[WMI Reconnaissance Software](tests/718aebaa-d0e0-471a-8241-c5afa69c7414.md) ['windows'] :x: 

[WMI Reconnaissance List Remote Services](tests/0fd48ef7-d890-4e93-a533-f7dedd5191d3.md) ['windows'] :x: 

[WMI Execute Local Process](tests/b3bdfc91-b33e-4c6d-a5c8-d64bee0276b3.md) ['windows'] :x: 

[WMI Execute Remote Process](tests/9c8ef159-c666-472f-9874-90c8d60d136b.md) ['windows'] :x: 

[Create a Process using WMI Query and an Encoded Command](tests/7db7a7f9-9531-4840-9b30-46220135441c.md) ['windows'] :x: 

[Create a Process using obfuscated Win32_Process](tests/10447c83-fc38-462a-a936-5102363b1c43.md) ['windows'] :x: 

[WMI Execute rundll32](tests/00738d2a-4651-4d76-adf2-c43a41dfb243.md) ['windows'] :x: 

[PowerShell Lateral Movement using MMC20](tests/6dc74eb1-c9d6-4c53-b3b5-6f50ae339673.md) ['windows'] :x: 
...
[RDP hijacking](tests/a37ac520-b911-458e-8aed-c5f1576d9f46.md) ['windows'] :x: 

[RDP to DomainController](tests/355d4632-8cb9-449d-91ce-b566d0253d3e.md) ['windows'] :x: 

[RDP to Server](tests/7382a43e-f19c-46be-8f09-5c63af7d3e2b.md) ['windows'] :x: 

[Changing RDP Port to Non Standard Port via Powershell](tests/2f840dd4-8a2e-4f44-beb3-6b2399ea3771.md) ['windows'] :x: 

[Changing RDP Port to Non Standard Port via Command_Prompt](tests/74ace21e-a31c-4f7d-b540-53e4eb6d1f73.md) ['windows'] :x: 

[Map admin share](tests/3386975b-367a-4fbb-9d77-4dcf3639ffd3.md) ['windows'] :x: 

[Map Admin Share PowerShell](tests/514e9cd7-9207-4882-98b1-c8f791bae3c5.md) ['windows'] :x: 

[Copy and Execute File with PsExec](tests/0eb03d41-79e4-4393-8e57-6344856be1cf.md) ['windows'] :x: 

[Execute command writing output to local Admin Share](tests/d41aaab5-bdfe-431d-a3d5-c29e9136ff46.md) ['windows'] :x: 

[Radmin Viewer Utility](tests/b4988cad-6ed2-434d-ace5-ea2670782129.md) ['windows'] :x: 

[Enable Windows Remote Management](tests/9059e8de-3d7d-4954-a322-46161880b9cf.md) ['windows'] :x: 

[Invoke-Command](tests/5295bd61-bd7e-4744-9d52-85962a4cf2d6.md) ['windows'] :x: 

[WinRM Access with Evil-WinRM](tests/efe86d95-44c4-4509-ae42-7bfd9d1f5b3d.md) ['windows'] :x: 

[DNS Large Query Volume](tests/1700f5d6-5a44-487b-84de-bc66f507b0a6.md) ['windows'] :x: 

[DNS Regular Beaconing](tests/3efc144e-1af8-46bb-8ca2-1376bb6db8b6.md) ['windows'] :x: 

[DNS Long Domain Query](tests/fef31710-223a-40ee-8462-a396d6b66978.md) ['windows'] :x: 

[DNS C2](tests/e7bf9802-2e78-4db9-93b5-181b7bcd37d7.md) ['windows'] :x: 

[OpenSSL C2](tests/21caf58e-87ad-440c-a6b8-3ac259964003.md) ['windows'] :x: 

[rsync remote file copy (push)](tests/0fc6e977-cb12-44f6-b263-2824ba917409.md) ['linux', 'macos'] :x: 

[rsync remote file copy (pull)](tests/3180f7d5-52c0-4493-9ea0-e3431a84773f.md) ['linux', 'macos'] :x: 

[scp remote file copy (push)](tests/83a49600-222b-4866-80a0-37736ad29344.md) ['linux', 'macos'] :x: 

[scp remote file copy (pull)](tests/b9d22b9a-9778-4426-abf0-568ea64e9c33.md) ['linux', 'macos'] :x: 

[sftp remote file copy (push)](tests/f564c297-7978-4aa9-b37a-d90477feea4e.md) ['linux', 'macos'] :x: 
...
[Windows - BITSAdmin BITS Download](tests/a1921cd3-9a2d-47d5-a891-f1d0f2a7a31b.md) ['windows'] :x: 

[Windows - PowerShell Download](tests/42dc4460-9aa6-45d3-b1a6-3955d34e1fe8.md) ['windows'] :x: 

[OSTAP Worming Activity](tests/2ca61766-b456-4fcf-a35a-1233685e1cad.md) ['windows'] :x: 

[svchost writing a file to a UNC path](tests/fa5a2759-41d7-4e13-a19c-e8f28a53566f.md) ['windows'] :x: 

[Download a File with Windows Defender MpCmdRun.exe](tests/815bef8b-bf91-4b67-be4c-abe4c2a94ccc.md) ['windows'] :x: 

[whois file download](tests/c99a829f-0bb8-4187-b2c6-d47d1df74cab.md) ['linux', 'macos'] :x: 

[File Download via PowerShell](tests/54a4daf1-71df-4383-9ba7-f1a295d8b6d2.md) ['windows'] :x: 

[File download with finger.exe on Windows](tests/5f507e45-8411-4f99-84e7-e38530c45d01.md) ['windows'] :x: 

[Download a file with IMEWDBLD.exe](tests/1a02df58-09af-4064-a765-0babe1a0d1e2.md) ['windows'] :x: 

[Curl Download File](tests/2b080b99-0deb-4d51-af0f-833d37c4ca6a.md) ['windows'] :x: 

[Curl Upload File](tests/635c9a38-6cbf-47dc-8615-3810bc1167cf.md) ['windows'] :x: 

[Connection Proxy](tests/0ac21132-4485-4212-a681-349e8a6637cd.md) ['macos', 'linux'] :x: 

[Connection Proxy for macOS UI](tests/648d68c1-8bcd-4486-9abe-71c6655b6a2c.md) ['macos'] :x: 

[portproxy reg key](tests/b8223ea9-4be2-44a6-b50a-9657a3d4e72a.md) ['windows'] :x: 

[ICMP C2](tests/0268e63c-e244-42db-bef7-72a9e59fc1fc.md) ['windows'] :x: 

[Netcat C2](tests/bcf0d1c1-3f6a-4847-b1c9-7ed4ea321f37.md) ['windows'] :x: 

[Powercat C2](tests/3e0e0e7f-6aa2-4a61-b61d-526c2cc9330e.md) ['windows'] :x: 

[Testing usage of uncommonly used port with PowerShell](tests/21fe622f-8e53-4b31-ba83-6d333c2583f4.md) ['windows'] :x: 

[Testing usage of uncommonly used port](tests/5db21e1d-dd9c-4a50-b885-b1e748912767.md) ['linux', 'macos'] :x: 

[DNS over HTTPS Large Query Volume](tests/ae9ef4b0-d8c1-49d4-8758-06206f19af0a.md) ['windows'] :x: 

[DNS over HTTPS Regular Beaconing](tests/0c5f9705-c575-42a6-9609-cbbff4b2fc9b.md) ['windows'] :x: 

[DNS over HTTPS Long Domain Query](tests/748a73d5-cea4-4f34-84d8-839da5baa99c.md) ['windows'] :x: 

[TeamViewer Files Detected Test on Windows](tests/8ca3b96d-8983-4a7f-b125-fc98cc0a2aa0.md) ['windows'] :x: 

[AnyDesk Files Detected Test on Windows](tests/6b8b7391-5c0a-4f8c-baee-78d8ce0ce330.md) ['windows'] :x: 

[LogMeIn Files Detected Test on Windows](tests/d03683ec-aae0-42f9-9b4c-534780e0f8e1.md) ['windows'] :x: 

[GoToAssist Files Detected Test on Windows](tests/1b72b3bd-72f8-4b63-a30b-84e91b9c3578.md) ['windows'] :x: 

[ScreenConnect Application Download and Install on Windows](tests/4a18cc4e-416f-4966-9a9d-75731c4684c0.md) ['windows'] :x: 

[Base64 Encoded data.](tests/1164f70f-9a88-4dff-b9ff-dc70e7bf0c25.md) ['macos', 'linux'] :x: 

[XOR Encoded data.](tests/c3ed6d2a-e3ad-400d-ad78-bbfdbfeacc08.md) ['windows'] :x: 

[Malicious User Agents - Powershell](tests/81c13829-f6c9-45b8-85a6-053366d55297.md) ['windows'] :x: 

[Malicious User Agents - CMD](tests/dc3488b0-08c7-4fea-b585-905c83b48180.md) ['windows'] :x: 

[Malicious User Agents - Nix](tests/2d7c471a-e887-4b78-b0dc-b0df1f2e0658.md) ['linux', 'macos'] :x: 

[IcedID Botnet HTTP PUT](tests/9c780d3d-3a14-4278-8ee5-faaeb2ccfbe0.md) ['windows'] :x: 

[Data Transfer Size Limits](tests/ab936c51-10f4-46ce-9144-e02137b2016a.md) ['macos', 'linux'] :x: 

[Exfiltration Over Alternative Protocol - SSH](tests/f6786cc8-beda-4915-a4d6-ac2f193bb988.md) ['macos', 'linux'] :x: 

[Exfiltration Over Alternative Protocol - SSH](tests/7c3cb337-35ae-4d06-bf03-3032ed2ec268.md) ['macos', 'linux'] :x: 

[DNSExfiltration (doh)](tests/c943d285-ada3-45ca-b3aa-7cd6500c6a48.md) ['windows'] :x: 

[Exfiltrate data HTTPS using curl](tests/4a4f31e2-46ea-4c26-ad89-f09ad1d5fe01.md) ['windows', 'macos', 'linux'] :x: 

[C2 Data Exfiltration](tests/d1253f6e-c29b-49dc-b466-2147a6191932.md) ['windows'] :x: 

[Exfiltration Over Alternative Protocol - HTTP](tests/1d1abbd6-a3d3-4b2e-bef5-c59293f46eff.md) ['macos', 'linux'] :x: 

[Exfiltration Over Alternative Protocol - ICMP](tests/dd4b4421-2e25-4593-90ae-7021947ad12e.md) ['windows'] :x: 

[Exfiltration Over Alternative Protocol - DNS](tests/c403b5a4-b5fc-49f2-b181-d1c80d27db45.md) ['linux'] :x: 

[Exfiltration Over Alternative Protocol - HTTP](tests/6aa58451-1121-4490-a8e9-1dada3f1c68c.md) ['windows'] :x: 

[Exfiltration Over Alternative Protocol - SMTP](tests/ec3a835e-adca-4c7c-88d2-853b69c11bb9.md) ['windows'] :x: 

[Data Exfiltration with ConfigSecurityPolicy](tests/5568a8f4-a8b1-4c40-9399-4969b642f122.md) ['windows'] :x: 
...
[Download Phishing Attachment - VBScript](tests/114ccff9-ae6d-4547-9ead-4cd69f687306.md) ['windows'] :x: 

[Word spawned a command shell and used an IP address in the command line](tests/cbb6799a-425c-4f83-9194-5447a909d67f.md) ['windows'] :x: 
