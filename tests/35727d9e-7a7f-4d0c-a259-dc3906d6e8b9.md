...
# Test : Mimic Ransomware - Allow Multiple RDP Sessions per User
## OS
  - windows
...
# Sigma Rule
 - proc_creation_win_reg_rdp_keys_tamper.yml (id: 0d5675be-bc88-4172-86d3-1e96a4476536)

 - registry_set_terminal_server_suspicious.yml (id: a2863fbc-d5cb-48d5-83fb-d976d4b1743b)
