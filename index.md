...
[Driver Enumeration using DriverQuery](tests/bd85e3d1-4aeb-4a1d-850f-7be3cb8d60b9.md) ['windows'] (sigma rule :x:)
...
[Suspicious LAPS Attributes Query with Get-ADComputer all properties and SearchScope](tests/ffbcfd62-15d6-4989-a21a-80bfc8e58bb5.md) ['windows'] (sigma rule :x:)
...
[Suspicious LAPS Attributes Query with adfind ms-Mcs-AdmPwd](tests/51a98f96-0269-4e09-a10f-e307779a8b05.md) ['windows'] (sigma rule :x:)

[Suspicious LAPS Attributes Query with adfind all properties](tests/abf00f6c-9983-4d9a-afbc-6b1c6c6448e1.md) ['windows'] (sigma rule :x:)

[Automated AD Recon (ADRecon)](tests/95018438-454a-468c-a0fa-59c800149b59.md) ['windows'] (sigma rule :heavy_check_mark:)

[Active Directory Domain Search](tests/096b6d2a-b63f-4100-8fa0-525da4cd25ca.md) ['linux'] (sigma rule :x:)

[Get-DomainUser with PowerView](tests/93662494-5ed7-4454-a04c-8c8372808ac2.md) ['windows'] (sigma rule :heavy_check_mark:)

[Suspicious LAPS Attributes Query with Get-ADComputer ms-Mcs-AdmPwd property](tests/6e85bdf9-7bc4-4259-ac0f-f0cb39964443.md) ['windows'] (sigma rule :x:)
...
[Suspicious LAPS Attributes Query with Get-ADComputer all properties](tests/394012d9-2164-4d4f-b9e5-acf30ba933fe.md) ['windows'] (sigma rule :x:)
...
[Wevtutil - Discover NTLM Users Remote](tests/b8a563d4-a836-4993-a74e-0a19b8481bfe.md) ['windows'] (sigma rule :heavy_check_mark:)
...
[XOR decoding and command execution using Python](tests/c3b65cd5-ee51-4e98-b6a3-6cbdec138efc.md) ['linux', 'macos'] (sigma rule :x:)
...
### T1547.015
[Add macOS LoginItem using Applescript](tests/716e756a-607b-41f3-8204-b214baf37c1d.md) ['macos'] (sigma rule :x:)
...
[Do Not Connect To Win Update](tests/d1de3767-99c2-4c6c-8c5a-4ba4586474c8.md) ['windows'] (sigma rule :x:)
...
[Disable Windows OS Auto Update](tests/01b20ca8-c7a3-4d86-af59-059f15ed5474.md) ['windows'] (sigma rule :x:)
...
[Tamper Win Defender Protection](tests/3b625eaa-c10d-4635-af96-3eae7d2a2f3c.md) ['windows'] (sigma rule :x:)
...
[Windows Auto Update Option to Notify before download](tests/335a6b15-b8d2-4a3f-a973-ad69aa2620d7.md) ['windows'] (sigma rule :x:)
...
[Disable Win Defender Notification](tests/12e03af7-79f9-4f95-af48-d3f12f28a260.md) ['windows'] (sigma rule :x:)
...
[Disable Windows Auto Reboot for current logon user](tests/396f997b-c5f8-4a96-bb2c-3c8795cf459d.md) ['windows'] (sigma rule :x:)
...
[Snake Malware Registry Blob](tests/8318ad20-0488-4a64-98f4-72525a012f6b.md) ['windows'] (sigma rule :x:)

[Mimic Ransomware - Enable Multiple User Sessions](tests/39f1f378-ba8a-42b3-96dc-2a6540cfc1e3.md) ['windows'] (sigma rule :x:)

[Allow Simultaneous Download Registry](tests/37950714-e923-4f92-8c7c-51e4b6fffbf6.md) ['windows'] (sigma rule :x:)
...
[Encrypt files using 7z utility - macOS](tests/645f0f5a-ef09-48d8-b9bc-f0e24c642d72.md) ['macos'] (sigma rule :x:)
...
[Encrypt files using openssl utility - macOS](tests/1a01f6b8-b1e8-418e-bbe3-78a6f822759e.md) ['macos'] (sigma rule :x:)
...
### T1069.002
[Active Directory Domain Search Using LDAP - Linux (Ubuntu)/macOS](tests/d58d749c-4450-4975-a9e9-8b1d562755c2.md) ['linux'] (sigma rule :x:)
...
[Active Directory Enumeration with LDIFDE](tests/22cf8cb9-adb1-4e8c-80ca-7c723dfc8784.md) ['windows'] (sigma rule :heavy_check_mark:)
...
[Find AWS credentials](tests/2b93758e-a8d7-4e3b-bc7b-d3aa8d7ecb17.md) ['macos', 'linux'] (sigma rule :x:)
...
[AWS - GuardDuty Suspension or Deletion](tests/11e65d8d-e7e4-470e-a3ff-82bc56ad938e.md) ['iaas:aws'] (sigma rule :x:)
...
[MacOS - Load Kernel Module via kextload and kmutil](tests/f4391089-d3a5-4dd1-ab22-0419527f2672.md) ['macos'] (sigma rule :x:)

[Linux - Load Kernel Module via insmod](tests/687dcb93-9656-4853-9c36-9977315e9d23.md) ['linux'] (sigma rule :x:)

[MacOS - Load Kernel Module via KextManagerLoadKextWithURL()](tests/f0007753-beb3-41ea-9948-760785e4c1e5.md) ['macos'] (sigma rule :x:)
...
[Retrieve Microsoft IIS Service Account Credentials Using AppCmd (using list)](tests/6c7a4fd3-5b0b-4b30-a93e-39411b25d889.md) ['windows'] (sigma rule :heavy_check_mark:)

[Retrieve Microsoft IIS Service Account Credentials Using AppCmd (using config)](tests/42510244-5019-48fa-a0e5-66c3b76e6049.md) ['windows'] (sigma rule :heavy_check_mark:)
...
### T1098
[Domain Password Policy Check: Short Password](tests/fc5f9414-bd67-4f5f-a08e-e5381e29cbd1.md) ['windows'] (sigma rule :heavy_check_mark:)

[Domain Password Policy Check: No Uppercase Character in Password](tests/b299c120-44a7-4d68-b8e2-8ba5a28511ec.md) ['windows'] (sigma rule :x:)
...
[Domain Password Policy Check: Common Password Use](tests/81959d03-c51f-49a1-bb24-23f1ec885578.md) ['windows'] (sigma rule :x:)
...
[Domain Password Policy Check: No Special Character in Password](tests/7d984ef2-2db2-4cec-b090-e637e1698f61.md) ['windows'] (sigma rule :x:)

[Azure - adding user to Azure role in subscription](tests/1a94b3fc-b080-450a-b3d8-6d9b57b472ea.md) ['iaas:azure'] (sigma rule :x:)

[Domain Password Policy Check: No Lowercase Character in Password](tests/945da11e-977e-4dab-85d2-f394d03c5887.md) ['windows'] (sigma rule :x:)

[GCP - Delete Service Account Key](tests/7ece1dea-49f1-4d62-bdcc-5801e3292510.md) ['iaas:gcp'] (sigma rule :x:)
...
[Domain Password Policy Check: No Number in Password](tests/68190529-069b-4ffc-a942-919704158065.md) ['windows'] (sigma rule :x:)

[Domain Password Policy Check: Only Two Character Classes](tests/784d1349-5a26-4d20-af5e-d6af53bae460.md) ['windows'] (sigma rule :x:)
...
[Permission Groups Discovery for Containers- Local Groups](tests/007d7aa4-8c4d-4f55-ba6a-7c965d51219c.md) ['containers'] (sigma rule :x:)
...
[Google Chrome Load Unpacked Extension With Command Line](tests/7a714703-9f6b-461c-b06d-e6aeac650f27.md) ['windows'] (sigma rule :heavy_check_mark:)
...
[Append commands user shell profile](tests/bbdb06bc-bab6-4f5b-8232-ba3fbed51d77.md) ['linux'] (sigma rule :x:)

[System shell profile scripts](tests/8fe2ccfd-f079-4c03-b1a9-bd9b362b67d4.md) ['linux'] (sigma rule :x:)

[Create/Append to .bash_logout](tests/37ad2f24-7c53-4a50-92da-427a4ad13f58.md) ['linux'] (sigma rule :x:)
...
### T1547.005
[Modify HKLM:\System\CurrentControlSet\Control\Lsa\OSConfig Security Support Provider configuration in registry](tests/de3f8e74-3351-4fdb-a442-265dbf231738.md) ['windows'] (sigma rule :x:)

[Modify HKLM:\System\CurrentControlSet\Control\Lsa Security Support Provider configuration in registry](tests/afdfd7e3-8a0b-409f-85f7-886fdf249c9e.md) ['windows'] (sigma rule :heavy_check_mark:)
...
[Network Share Discovery via dir command](tests/13daa2cf-195a-43df-a8bd-7dd5ffb607b5.md) ['windows'] (sigma rule :x:)
...
### T1098.002
[EXO - Full access mailbox permission granted to a user](tests/17d046be-fdd0-4cbb-b5c7-55c85d9d0714.md) ['office-365'] (sigma rule :x:)
...
[GCP - Delete Activity Event Log](tests/d56152ec-01d9-42a2-877c-aac1f6ebe8e6.md) ['iaas:gcp'] (sigma rule :x:)
...
[Port-Scanning /24 Subnet with PowerShell](tests/05df2a79-dba6-4088-a804-9ca0802ca8e4.md) ['windows'] (sigma rule :x:)

[WinPwn - spoolvulnscan](tests/54574908-f1de-4356-9021-8053dd57439a.md) ['windows'] (sigma rule :heavy_check_mark:)

[Network Service Discovery for Containers](tests/06eaafdb-8982-426e-8a31-d572da633caa.md) ['containers'] (sigma rule :x:)
...
[Obfuscated command line scripts](tests/5bec4cc8-f41e-437b-b417-33ff60acf9af.md) ['linux'] (sigma rule :x:)

[LinEnum tool execution](tests/a2b35a63-9df1-4806-9a4d-5fe0500845f2.md) ['linux'] (sigma rule :x:)

[What shells are available](tests/bf23c7dc-1004-4949-8262-4c1d1ef87702.md) ['linux'] (sigma rule :x:)
...
[Detecting pipe-to-shell](tests/fca246a8-a585-4f28-a2df-6495973976a1.md) ['linux'] (sigma rule :x:)
...
[AWS - Password Spray an AWS using GoAWSConsoleSpray](tests/9c10d16b-20b1-403a-8e67-50ef7117ed4e.md) ['iaas:aws'] (sigma rule :x:)
...
### T1562.003
[Setting the HISTFILESIZE environment variable](tests/5cafd6c1-2f43-46eb-ac47-a5301ba0a618.md) ['linux'] (sigma rule :x:)

[Setting the HISTFILE environment variable](tests/b3dacb6c-a9e3-44ec-bf87-38db60c5cad1.md) ['linux'] (sigma rule :x:)

[Setting the HISTIGNORE environment variable](tests/f12acddb-7502-4ce6-a146-5b62c59592f1.md) ['linux'] (sigma rule :x:)

[Clear bash history](tests/878794f7-c511-4199-a950-8c28b3ed8e5b.md) ['linux'] (sigma rule :x:)

[Setting the HISTCONTROL environment variable](tests/10ab786a-028e-4465-96f6-9e83ca6c5f24.md) ['linux'] (sigma rule :x:)
...
[Execution from Compressed JScript File](tests/fad04df1-5229-4185-b016-fb6010cd87ac.md) ['windows'] (sigma rule :x:)

[Snake Malware Encrypted crmlog file](tests/7e47ee60-9dd1-4269-9c4f-97953b183268.md) ['windows'] (sigma rule :x:)
...
[MSP360 Connect Execution](tests/b1b8128b-c5d4-4de9-bf70-e60419274562.md) ['windows'] (sigma rule :x:)
...
[Python3 http.server](tests/3ea1f938-f80a-4305-9aa8-431bc4867313.md) ['linux'] (sigma rule :x:)
...
[Disable Windows IIS HTTP Logging via PowerShell](tests/a957fb0f-1e85-49b2-a211-413366784b1e.md) ['windows'] (sigma rule :x:)
...
[Makes Eventlog blind with Phant0m](tests/3ddf3d03-f5d6-462a-ad76-2c5ff7b6d741.md) ['windows'] (sigma rule :x:)
...
[List All Secrets](tests/31e794c4-48fd-4a76-aca4-6587c155bc11.md) ['containers'] (sigma rule :x:)
...
[LOLBAS CustomShellHost to Spawn Process](tests/b1eeb683-90bb-4365-bbc2-2689015782fe.md) ['windows'] (sigma rule :x:)
...
### T1136.002
[Active Directory Create Admin Account](tests/562aa072-524e-459a-ba2b-91f1afccf5ab.md) ['linux'] (sigma rule :x:)
...
[Active Directory Create User Account (Non-elevated)](tests/8c992cb3-a46e-4fd5-b005-b1bab185af31.md) ['linux'] (sigma rule :x:)
...
[Windows - vssadmin Resize Shadowstorage Volume](tests/da558b07-69ae-41b9-b9d4-4d98154a7049.md) ['windows'] (sigma rule :x:)
...
### T1078.003
[Add a new/existing user to the admin group using dseditgroup utility - macOS](tests/433842ba-e796-4fd5-a14f-95d3a1970875.md) ['macos'] (sigma rule :x:)
...
[Login as nobody (Linux)](tests/3d2cd093-ee05-41bd-a802-59ee5c301b85.md) ['linux'] (sigma rule :x:)

[Reactivate a locked/expired account (Linux)](tests/d2b95631-62d7-45a3-aaef-0972cea97931.md) ['linux'] (sigma rule :x:)
...
[Create local account with admin privileges using sysadminctl utility - MacOS](tests/191db57d-091a-47d5-99f3-97fde53de505.md) ['macos'] (sigma rule :x:)

[Enable root account using dsenableroot utility - MacOS](tests/20b40ea9-0e17-4155-b8e6-244911a678ac.md) ['macos'] (sigma rule :x:)

[Create local account (Linux)](tests/02a91c34-8a5b-4bed-87af-501103eb5357.md) ['linux'] (sigma rule :x:)
...
[Modify/delete iptables firewall rules](tests/899a7fb5-d197-4951-8614-f19ac4a73ad4.md) ['linux'] (sigma rule :x:)
...
[Disable iptables](tests/7784c64e-ed0b-4b65-bf63-c86db229fd56.md) ['linux'] (sigma rule :x:)
...
[Encrypts collected data with AES-256 and Base64](tests/a743e3a6-e8b2-4a30-abe7-ca85d201b5d3.md) ['linux', 'macos'] (sigma rule :x:)
...
[Persistent Code Execution Via Excel VBA Add-in File (XLAM)](tests/082141ed-b048-4c86-99c7-2b8da5b5bf48.md) ['windows'] (sigma rule :x:)
...
[linux rename /proc/pid/comm using prctl](tests/f0e3aaea-5cd9-4db6-a077-631dd19b27a8.md) ['linux'] (sigma rule :x:)
...
### T1070.008
[Copy and Modify Mailbox Data on Windows](tests/edddff85-fee0-499d-9501-7d4d2892e79b.md) ['windows'] (sigma rule :x:)

[Copy and Modify Mailbox Data on macOS](tests/8a0b1579-5a36-483a-9cde-0236983e1665.md) ['macos'] (sigma rule :x:)

[Copy and Delete Mailbox Data on Windows](tests/d29f01ea-ac72-4efc-8a15-bea64b77fabf.md) ['windows'] (sigma rule :x:)

[Copy and Delete Mailbox Data on macOS](tests/3824130e-a6e4-4528-8091-3a52eeb540f6.md) ['macos'] (sigma rule :x:)

[Copy and Modify Mailbox Data on Linux](tests/6d99f93c-da56-49e3-b195-163090ace4f6.md) ['linux'] (sigma rule :x:)

[Copy and Delete Mailbox Data on Linux](tests/25e2be0e-96f7-4417-bd16-a4a2500e3802.md) ['linux'] (sigma rule :x:)
...
[SUDO Brute Force - Debian](tests/ba1bf0b6-f32b-4db0-b7cc-d78cacc76700.md) ['linux'] (sigma rule :x:)
...
[SUDO Brute Force - Redhat](tests/4097bc00-5eeb-4d56-aaf9-287d60351d95.md) ['linux'] (sigma rule :x:)
...
[Examine AWS Password Policy](tests/15330820-d405-450b-bd08-16b5be5be9f4.md) ['iaas:aws'] (sigma rule :x:)
...
### T1539
[Steal Chrome Cookies via Remote Debugging (Mac)](tests/e43cfdaf-3fb8-4a45-8de0-7eee8741d072.md) ['macos'] (sigma rule :x:)
...
### T1027.006
[HTML Smuggling Remote Payload](tests/30cbeda4-08d9-42f1-8685-197fad677734.md) ['windows'] (sigma rule :x:)
...
[Docker Exec Into Container](tests/900e2c49-221b-42ec-ae3c-4717e41e6219.md) ['containers'] (sigma rule :x:)
...
[System Discovery - SocGholish whoami](tests/3d257a03-eb80-41c5-b744-bb37ac7f65c7.md) ['windows'] (sigma rule :heavy_check_mark:)
...
### T1531
[Azure AD - Delete user via Azure AD PowerShell](tests/4f577511-dc1c-4045-bcb8-75d2457f01f4.md) ['azure-ad'] (sigma rule :x:)

[Change User Password via passwd](tests/3c717bf3-2ecc-4d79-8ac8-0bfbf08fbce6.md) ['macos', 'linux'] (sigma rule :x:)
...
[Delete User via dscl utility](tests/4d938c43-2fe8-4d70-a5b3-5bf239aa7846.md) ['macos'] (sigma rule :x:)

[Azure AD - Delete user via Azure CLI](tests/c955c1c7-3145-4a22-af2d-63eea0d967f0.md) ['azure-ad'] (sigma rule :x:)

[Change User Password - Windows](tests/1b99ef28-f83c-4ec5-8a08-1a56263a5bb2.md) ['windows'] (sigma rule :heavy_check_mark:)

[Delete User via sysadminctl utility](tests/d3812c4e-30ee-466a-a0aa-07e355b561d6.md) ['macos'] (sigma rule :x:)
...
### T1547.007
[Append to existing loginwindow for Re-Opened Applications](tests/766b6c3c-9353-4033-8b7e-38b309fa3a93.md) ['macos'] (sigma rule :x:)

[Copy in loginwindow.plist for Re-Opened Applications](tests/5fefd767-ef54-4ac6-84d3-751ab85e8aba.md) ['macos'] (sigma rule :x:)

[Re-Opened Applications using LoginHook](tests/5f5b71da-e03f-42e7-ac98-d63f9e0465cb.md) ['macos'] (sigma rule :x:)
...
### T1564
[Command Execution with NirCmd](tests/2748ab4a-1e0b-4cf2-a2b0-8ef765bec7be.md) ['windows'] (sigma rule :x:)
...
[Create and Hide a Service with sc.exe](tests/333c7de0-6fbe-42aa-ac2b-c7e40b18246a.md) ['windows'] (sigma rule :heavy_check_mark:)
...
### T1072
[PDQ Deploy RAT](tests/e447b83b-a698-4feb-bed1-a7aaf45c3443.md) ['windows'] (sigma rule :heavy_check_mark:)
...
### T1114.003
[Office365 - Email Forwarding](tests/3234117e-151d-4254-9150-3d0bac41e38c.md) ['office-365'] (sigma rule :x:)


### T1485
[Overwrite deleted data on C drive](tests/321fd25e-0007-417f-adec-33232252be19.md) ['windows'] (sigma rule :heavy_check_mark:)

[GCP - Delete Bucket](tests/4ac71389-40f4-448a-b73f-754346b3f928.md) ['iaas:gcp'] (sigma rule :x:)
...
[System Time Discovery W32tm as a Delay](tests/d5d5a6b0-0f92-42d8-985d-47aafa2dd4db.md) ['windows'] (sigma rule :heavy_check_mark:)
...
[Enable Guest Account on macOS](tests/0315bdff-4178-47e9-81e4-f31a6d23f7e4.md) ['macos'] (sigma rule :x:)
...
### T1204.003
[Malicious Execution from Mounted ISO Image](tests/e9795c8d-42aa-4ed4-ad80-551ed793d006.md) ['windows'] (sigma rule :heavy_check_mark:)
...
### T1098.003
[Azure AD - Add Company Administrator Role to a user](tests/4d77f913-56f5-4a14-b4b1-bf7bb24298ad.md) ['azure-ad'] (sigma rule :x:)
...
[Azure Persistence Automation Runbook Created or Modified](tests/348f4d14-4bd3-4f6b-bd8a-61237f78b3ac.md) ['iaas:azure'] (sigma rule :x:)

[GCP - Create Custom IAM Role](tests/3a159042-69e6-4398-9a69-3308a4841c85.md) ['iaas:gcp'] (sigma rule :x:)
...
### T1012
[Query Registry with Powershell cmdlets](tests/0434d081-bb32-42ce-bcbb-3548e4f2628f.md) ['windows'] (sigma rule :x:)
...
### T1610
[Deploy Docker container](tests/59aa6f26-7620-417e-9318-589e0fb7a372.md) ['containers'] (sigma rule :x:)
...
### T1612
[Build Image On Host](tests/2db30061-589d-409b-b125-7b473944f9b3.md) ['containers'] (sigma rule :x:)
...
### T1039
[Copy a sensitive File over Administrative share with copy](tests/6ed67921-1774-44ba-bac6-adb51ed60660.md) ['windows'] (sigma rule :heavy_check_mark:)

[Copy a sensitive File over Administrative share with Powershell](tests/7762e120-5879-44ff-97f8-008b401b9a98.md) ['windows'] (sigma rule :heavy_check_mark:)
